...
void MmaSensor::processEvent(int code, int value)
{
    ...
    switch (code) {
        case EVENT_TYPE_ACCEL_X:
            ...
            mPendingEvents[Accelerometer].acceleration.x = ((value) *(GRAVITY_EARTH / (1004544.0f)));//value * ACCELERATION_RATIO_ANDROID_TO_HW;
            break;
        case EVENT_TYPE_ACCEL_Y:
            mPendingMask |= 1<<Accelerometer;
            mPendingEvents[Accelerometer].acceleration.y = ((value) *(GRAVITY_EARTH / (1004544.0f)));//value * ACCELERATION_RATIO_ANDROID_TO_HW;
            break;
        case EVENT_TYPE_ACCEL_Z:
            mPendingMask |= 1<<Accelerometer;
            mPendingEvents[Accelerometer].acceleration.z = ((value) *(GRAVITY_EARTH / (1004544.0f)));//value * ACCELERATION_RATIO_ANDROID_TO_HW;
            break;
    }
}
