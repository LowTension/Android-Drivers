...
#define GMA_BACKUP_FILE	// enable the GMS30x backup (gsensor offset file)
#ifdef GMA_BACKUP_FILE
static const char *OFFSET_FILE_PATH = "/data/misc/gsensor_offset.txt";
static const char *TEMPORARY_BACKUP_PATH = "/tmp/gsensor_offset.txt";
static const char *DEST_FILE_PATH="/data/misc/gsensor_offset.txt";
#endif
...
#ifdef GMA_BACKUP_FILE
static int globalmems_copy_file(const char *src,const char *dstFilePath)
{
    ...
    free(buffer);
    check_and_fclose(fout,dstFilePath);
    check_and_fclose(fin,src);
...
#ifdef GMA_BACKUP_FILE
	globalmems_copy_file(OFFSET_FILE_PATH,TEMPORARY_BACKUP_PATH);
#endif
...
#ifdef GMA_BACKUP_FILE
		globalmems_copy_file(TEMPORARY_BACKUP_PATH,DEST_FILE_PATH);
