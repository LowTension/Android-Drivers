...
import com.globalmems.level.config.DisplayType;
import com.globalmems.level.config.Provider;
import com.globalmems.level.config.Viscosity;
...
public class LevelPreferences extends PreferenceActivity implements OnPreferenceChangeListener {
	...
	public static final String KEY_LOCK_LOCKED		 	= "preference_lock_locked";			// m�moriser le verouillage
	public static final String KEY_LOCK_ORIENTATION 	= "preference_lock_orientation";	// m�moriser l'orientation verouill�e
