...
import java.io.InputStream;//bruce add
import java.io.InputStreamReader;//bruce add
import java.io.BufferedReader;//bruce add
import java.io.FileInputStream;//bruce add
import java.io.IOException;//bruce add
...
public class DisplaySettings extends SettingsPreferenceFragment implements
	...
	String cmd=new String(); //bruce add
	FileInputStream input = null; //bruce add
		...
		/********* bruce add ********/
			Runtime rt;
			  ...
			  try {
                    ...
                    Process proc1 = rt.exec(cmd.toString());
                  ...
                  InputStream is = proc1.getInputStream();
                    ...
                    String GME60X="gme60x";
                    String GME605="gme605a";
                    String GME601="gme601a";
                    try {
                        while ((line = br.readLine()) != null) {
                        	Log.d(TAG, line );
                            if (line.equals(GMA303) || line.equals(GMA30x) || line.equals(GME605)|| line.equals(GME601)|| line.equals(GME60X)) {
                                Log.d(TAG, "found gsensor " + line);
                                break;
                            }else{
								Log.d(TAG, "no found globalmems gsensor " + line);
								//getPreferenceScreen().removePreference(findPreference("gma_ACC")); //For non-Mtk platform
								mDisplaySettingsExt.removePreference(findPreference("gma_ACC")); //For Mtk platform
							}
                        }
                    } catch (IOException e) {
                        e.printStackTrace();
                  ...
                  if((line = br.readLine()) == null) {
                     ...
                     getPreferenceScreen().removePreference(findPreference("gma_ACC"));
                    }
				} catch (IOException e) {
            ...
            new BaseSearchIndexProvider() {
                ...
                public List<String> getNonIndexableKeys(Context context) {
                    ...
                    if (!context.getResources().getBoolean(
                            ...
                            || FeatureOption.MTK_LCA_RAM_OPTIMIZE) {
