...
#define GMA_DEFAULT_SENSITIVITY 1024	/* raw data sensitivity 256(LSB)*4 */
#define GMA30x_ABSMAX_16G	(GMA_DEFAULT_SENSITIVITY * 16)
#define LevelValueRange_0_0078125	(GMA_DEFAULT_SENSITIVITY/128)/* Level conditions about 0.0078125g,ps: gma30x 1g=512(LSB) |X| < 2(LSB) && |Y| < 2(LSB)*/
#define LevelValueRange_0_015625	(GMA_DEFAULT_SENSITIVITY/64)/* Level conditions about 0.015625g	, 4(LSB)	*/
#define LevelValueRange_0_03125		(GMA_DEFAULT_SENSITIVITY/32)/* Level conditions about 0.03125g	, 8(LSB)	*/
#define LevelValueRange_0_0625		(GMA_DEFAULT_SENSITIVITY/16)/* Level conditions about 0.0625g	, 16(LSB)	*/
#define LevelValueRange_0_1			(GMA_DEFAULT_SENSITIVITY/10)/* Level conditions about 0.1000g	, 25(LSB)	*/
#define LevelValueRange_0_125		(GMA_DEFAULT_SENSITIVITY/8)	/* Level conditions about 0.1250g	, 32(LSB)	*/
#define LevelValueRange_0_25		(GMA_DEFAULT_SENSITIVITY/4)	/* Level conditions about 0.2500g	, 64(LSB)	*/
#define LevelValueRange_0_5			(GMA_DEFAULT_SENSITIVITY/2)	/* Level conditions about 0.5000g	, 128(LSB)	*/
#define LevelValueRange_2_0			(GMA_DEFAULT_SENSITIVITY*2)	/* Level conditions about 2.0000g	*/
#define LevelValueRange_1_8			1800						/* Level conditions about 1.8g	*/
