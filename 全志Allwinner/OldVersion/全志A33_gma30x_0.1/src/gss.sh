...
export PATH=/system/bin:/data/misc/sensor:$PATH
...
#################################################
DIR_SENSOR="/data/misc/sensor"					# Private directory 
FILE_OFFSET="offset.txt"						# The latest offset
FILE_OFFSET_LOG="offset.log"					# calibration History
