    ...
    {
        {
            ...
            125.0f, 1.0f,
            0.35f, 0,
            0,0,SENSOR_STRING_TYPE_AMBIENT_TEMPERATURE,
    ...
    {
        {
            ...
            360.0f,  CONVERT_O,
            0.50f,  100000,
            0,0,SENSOR_STRING_TYPE_ORIENTATION,
    ...
    {
        {
            ...
            6.1f, 1190,
            0,0,SENSOR_STRING_TYPE_GYROSCOPE,
            0,0,SENSOR_FLAG_WAKE_UP,
            { },
        },
    },
    ...
    {
        {
            ...
            2000.0f, CONVERT_M,
            6.8f, 16667,
            0,0,SENSOR_STRING_TYPE_MAGNETIC_FIELD,
            0,0,SENSOR_FLAG_WAKE_UP,
            { },
        },
    }, {
...
void setSensorData(int number,struct sensor_t *sensorList)
{
	...
	sSensorList[number].stringType = sensorList->stringType;
	sSensorList[number].requiredPermission = sensorList->requiredPermission;
	sSensorList[number].maxDelay = sensorList->maxDelay;
	sSensorList[number].flags =sensorList->flags;
