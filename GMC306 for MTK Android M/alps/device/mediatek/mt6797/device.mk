...
PRODUCT_PACKAGES += libmnlp_mt6797
PRODUCT_PACKAGES += gps.mt6797
PRODUCT_PACKAGES += gps.mt6797m
  ...
  ifeq ($(strip $(MTK_PLATFORM)), MT8127)
    ...
    ifeq ($(strip $(MTK_PLATFORM)), MT6571)
      ...
      ifeq ($(strip $(MTK_PLATFORM)), MT6735)
        ...
        ifeq ($(strip $(MTK_PLATFORM)), MT6797)
          PRODUCT_PACKAGES += WIFI_RAM_CODE_6797
        else
...
PRODUCT_COPY_FILES += $(LOCAL_PATH)/thermal.vsdof.6797.conf:system/etc/.tp/.thermal_policy_03
...
ifneq ($(MTK_AUDIO_TUNING_TOOL_VERSION),)
  ifneq ($(strip $(MTK_AUDIO_TUNING_TOOL_VERSION)),V1)
    MTK_AUDIO_PARAM_DIR_LIST += device/mediatek/mt6797/audio_param
