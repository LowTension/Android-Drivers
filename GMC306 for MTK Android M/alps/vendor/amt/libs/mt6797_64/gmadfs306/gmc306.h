...
#define GME60X_REG_ST1			0x00
#define GME60X_REG_HXH			0x01
#define GME60X_REG_HXL			0x02
#define GME60X_REG_HYH			0x03
#define GME60X_REG_HYL			0x04
#define GME60X_REG_HZH			0x05
#define GME60X_REG_HZL			0x06
#define GME60X_REG_TMPS			0x07
#define GME60X_REG_ST2			0x08
#define GME60X_REG_CNTL1		0x10
#define GME60X_REG_CNTL2		0x11
#define GME60X_REG_CNTL3		0x12

/*! \name GME60X fuse-rom address
\anchor GME60X_FUSE
Defines a read-only address of the fuse ROM of the GME60X.*/
#define GME60X_REG_CMPID		0x50// from GME60X_REG_WIA1
#define GME60X_REG_DEVID		0x51// from GME60X_REG_WIA2
#define GME60X_REG_INFO			0x52// from GME60X_REG_INFO1
#define GME60X_FUSE_ASAX		0x53
#define GME60X_FUSE_ASAY		0x54
#define GME60X_FUSE_ASAZ		0x55

/*! \name GME60X operation mode
 \anchor GME60X_Mode
 Defines an operation mode of the GME60X.*/
#define GME60X_MODE_SNG_MEASURE	(0xC1)
#define GME60X_MODE_SELF_TEST	(0xD0)
#define GME60X_MODE_FUSE_ACCESS	(0xDF)
#define GME60X_MODE_POWERDOWN	(0xC0)
#define GME60X_RESET_COMMAND	(0x01)

#define GME60X_REGS_SIZE		13
#define GME60X_CMPID_VALUE		0x13
#define GME60X_DEVID_VALUE		0x30
...
/* IOCTLs for gme60x/gmc303 device */
...
/*COMPAT IOCTLs for gme60x/gmc303 device */
