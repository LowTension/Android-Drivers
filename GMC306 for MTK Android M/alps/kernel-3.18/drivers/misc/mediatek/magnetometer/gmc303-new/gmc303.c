...
struct mag_hw *get_cust_mag_gmc303(void)
{
	return &mag_cust_1;
}
...
/*----------------------------------------------------------------------------*/
int gmc303_operate(void *self, uint32_t command, void *buff_in, int size_in,
...
/*----------------------------------------------------------------------------*/
int gmc303_orientation_operate(void *self, uint32_t command, void *buff_in, int size_in,
	void *buff_out, int size_out, int *actualout)
{
	int err = 0;
	int value;
...
{
	const char *name = "mediatek,gmc306";//gmc303
