...
#ifdef GMC303
//GMC303 register map
#define GMC303_REG_WIA1			0x00
#define GMC303_REG_WIA2			0x01
...
#define GMC303_FUSE_ASAX		0x60
#define GMC303_FUSE_ASAY		0x61
#define GMC303_FUSE_ASAZ		0x62


#define GMC303_MODE_SNG_MEASURE	(0x01)
#define GMC303_MODE_SELF_TEST	(0x10)
#define GMC303_MODE_FUSE_ACCESS	(0x1F)
#define GMC303_MODE_POWERDOWN	(0x00)
#define GMC303_RESET_COMMAND	(0x01)

#define GMC303_CMPID_VALUE		0x48
#define GMC303_DEVID_VALUE		0x05
#define GMC303_RESET_DATA 		0x01
#endif
...
#define GME_REG_MODE			GMC303_REG_CNTL2
#define GME_REG_RESET			GMC303_REG_CNTL3
#define GME_REG_STATUS			GMC303_REG_ST1
#define GME_REG_RAW_DATA_START 	GMC303_REG_HXH

#define GME_MODE_SNG_MEASURE 	GMC303_MODE_SNG_MEASURE
#define GME_MODE_POWERDOWN 		GMC303_MODE_POWERDOWN
#define GME_MODE_SELF_TEST 		GMC303_MODE_SELF_TEST
...
#define GME_CMPID_VALUE 		GMC303_CMPID_VALUE
#define GME_REG_CMPID 			GMC303_REG_WIA1
#define GME_MODE_FUSE_ACCESS 	GMC303_MODE_FUSE_ACCESS
#define GME_ReadChipInfo			"GMC303"
#define GME_FUSE_ASAX 			GMC303_FUSE_ASAX
...
#define GME_FUSE_1ST_ADDR		GMC303_FUSE_ASAX

#define GME_RESET_DATA			GMC303_RESET_DATA
...
#define CONVERT_M			1
#define CONVERT_M_DIV		1000			/* 15/1000 = CONVERT_M */
#define CONVERT_O			1
...
/* defined in Y:\global\mt6797\alps\kernel-3.18\drivers\misc\mediatek\hwmon\include\sensors_io.h
#define GSENSOR							0x85
...
#ifdef GMC303
#define TLIMIT_TN_RST_WIA				"RST_CMPID"
